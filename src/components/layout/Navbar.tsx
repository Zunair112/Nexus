...
import { Menu, X, Bell, MessageCircle, User, LogOut, Building2, CircleDollarSign, Video, Calendar as CalendarIcon } from 'lucide-react';
              ...
              <Link to="/" className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-primary-600 rounded-md flex items-center justify-center">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
                    ...
                    <path d="M16 21V5C16 3.89543 15.1046 3 14 3H10C8.89543 3 8 5V21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              ...
              {user ? (
                <div className="flex items-center space-x-4">
                  ...
                  >
                    ...
                    Video Call
                    {/* Optional: Incoming call indicator */}
